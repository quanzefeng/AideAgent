...
const translations = {
  zh: {
    ...
    "settings.social": "社交",
    "settings.memory": "记忆",
    "settings.prompts": "常用提示词",
    "settings.kb": "知识库",
    "settings.agent_skills": "Agent 技能",
    "settings.appearance": "外观",
    "bg.preset.cyberpunk": "赛博朋克",
    "settings.font": "字体",
    ...
    "api.fetch_btn": "获取模型",
    "api.key": "API Key",
    "api.context_window": "上下文窗口（可选）",
    "api.context_window_placeholder": "留空自动检测，如 65536",
    "api.context_window_hint": "手动覆盖上下文窗口大小，优先级高于自动检测",
    "api.context_window_invalid": "上下文窗口需留空或填 ≥ 4096 的数字",
    "api.save": "保存",
    ...
    // ── Import to input (Stage 4) ──
    "skills.import_btn": "📥 导入",
    "skills.import_btn_title": "导入到输入框",
    "skills.import_btn_loading": "导入中...",
    "skills.import_btn_done": "✅ 已导入",
    "skills.import_failed": "导入失败：",
    "skills.triggers": "触发:",
    ...
    "mcp.args": "参数 (args)",
    "mcp.args_placeholder": "例如: -y @modelcontextprotocol/server-filesystem C:/notes",
    ...
    "memory.stat_overflow": "⚠️",
    "memory.purge_btn_label": "清空项目",
    "memory.purge_btn_title": "清空所有项目记忆（不可撤销）",
    "memory.purge_confirm_title": "确认清空所有项目记忆？",
    "memory.purge_confirm_body": "即将删除 **{count}** 个项目记忆：\n\n{names}\n\n此操作**不可撤销**。建议先导出备份。\n\n确认清空？",
    "memory.purge_confirm_too_many": "⚠️ 项目记忆已达 {count} 条。建议先清空，否则会严重干扰 Agent 思考。",
    "memory.purge_done": "✅ 已清空 {count} 个项目记忆",

    // ── Prompts (Stage 2b) ──
    "prompts.title": "常用提示词",
    "prompts.hint": "点击输入框「+」按钮 → 常用提示词，选择后自动导入到对话框",
    "prompts.search_placeholder": "搜索提示词...",
    "prompts.new": "＋ 新建",
    "prompts.empty": "暂无提示词",
    "prompts.empty_hint": "选择一个提示词查看或编辑<br/>或点击「＋ 新建」创建新的提示词",
    "prompts.empty_hint_panel": "在右侧编辑器里写第一条",
    "prompts.title_placeholder": "标题，如「写日报」",
    "prompts.body_placeholder": "提示词内容（支持 Markdown）...",
    "prompts.title_required": "❌ 标题不能为空",
    "prompts.body_required": "❌ 内容不能为空",
    "prompts.saving": "保存中...",
    "prompts.saved": "✅ 已保存",
    "prompts.save_fail": "❌ 保存失败: {error}",
    "prompts.delete_confirm": "删除提示词 \"{name}\"？此操作不可撤销。",
    "prompts.deleted": "✅ 已删除",
    "prompts.delete_fail": "❌ 删除失败: {error}",
    "prompts.modal_title_edit": "编辑提示词",
    "prompts.modal_title_new": "新建提示词",
    "prompts.field_title": "标题 *",
    "prompts.field_body": "提示词内容 *",
    // ── Import modal (Stage 3) ──
    "prompts.import_modal_title": "选择提示词",
    "prompts.import_search_placeholder": "搜索提示词...",
    "prompts.import_select_hint": "← 在左侧选择一个提示词查看预览",
    "prompts.import_preview_placeholder": "（预览）",
    "prompts.import_btn": "导入到输入框",
    "prompts.import_failed": "❌ 导入失败，找不到输入框",
    "prompts.import_empty": "暂无提示词，请先在设置中创建",
    "memory.purge_fail": "❌ 清空失败: {error}",
    "memory.purge_disabled_hint": "项目记忆 ≤ {cap} 条，无需清理",
    "memory.export_btn_label": "导出备份",
    "memory.export_done": "✅ 备份已保存到 {path}",
    ...
    "agent_skills.generate_all": "全部自动提炼",
    "agent_skills.generate_all_title": "用 AI 一键把所有候选模式提炼成技能",
    "agent_skills.generated_ok": "已生成",
    "agent_skills.already_exists": "已存在",
    "agent_skills.generate_all_summary": "已生成 {saved} 个 / 已存在 {existed} 个 / 失败 {failed} 个",
    ...
    "chat.stop": "停止",
    "chat.plan": "计划",
    // ── Input Menu Popover (Stage 1) ──
    "input.menu.upload": "上传文件",
    "input.menu.prompts": "常用提示词",
    "input.menu.skills": "技能",
    ...
    "speed.seconds": "s",
    "speed.chars": "字符",
    "speed.cache_hit": "命中缓存",
    "speed.cache_hit_label": "缓存命中",
    "speed.cache_miss_label": "未命中",
    "speed.cache_total_label": "总请求",
    "settings.custom_suffix": "（自定义）",
    "settings.custom_model_placeholder": "手动输入模型名称...",
    "resume.banner": "⚠ 此对话在第 {turn} 轮（第 {cont} 次续写）中断。可发消息让 agent 继续。",
    "resume.view_summary": "查看上次摘要",
    "common.remove": "移除",
    "common.save_enter": "保存 (Enter)",
    "common.cancel_esc": "取消 (Esc)",
    "kb.detecting": "检测中…",
    "kb.formats.title": "文件格式",
    "kb.formats.docx": "Word 文档 (.docx)",
    "kb.formats.pptx": "PowerPoint 演示 (.pptx)",
    "kb.formats.csv": "CSV 表格 (.csv)",
    "kb.formats.xlsx": "Excel 表格 (.xlsx)",
    "kb.formats.pdf": "PDF 文档 (.pdf)",
    "kb.formats.hint": "开启后，重建索引时将扫描这些格式",
    "skills.cli_general_tool": "CLI 通用工具",
    "skills.cli_tool_suffix": "通用工具",
    "skills.auto_name_hint": "自动生成的占位名 — 点击 ✎ 修正",
    "skills.edit_zh_name": "编辑中文名",
    "skills.zh_name_placeholder": "输入中文名（留空清除自定义）",
    "skills.pattern_one": "💡 检测到重复模式 \"{phrase}\"（出现 {count} 次），可提炼为技能",
    "skills.pattern_many": "💡 检测到 {count} 个重复任务模式，可提炼为技能",
    "skills.open_skills_panel": "点击打开技能面板",
    "runtime.opencode.install_ways": "安装方式（任选其一）：",
    "common.loading": "加载中...",
    "common.close": "关闭",
    "common.drag_to_reorder": "拖动排序",
    "chat.welcome_desc": "任何事都可以找 AideAgent",
    "chat.input_menu_label": "输入菜单",
    "chat.web_search_hint": "联网搜索：关闭后 agent 无法使用 web_search 和 web_fetch 工具",
    "skills.enable_all_hint": "一键开启 / 全部关闭",
    "about.contact": "联系方式",
    "about.contact_wechat_label": "微信",
    "about.contact_email_label": "谷歌邮箱",
  ...
  en: {
    ...
    "api.key": "API Key",
    "api.context_window": "Context Window (optional)",
    "api.context_window_placeholder": "Auto-detect if empty, e.g. 65536",
    "api.context_window_hint": "Manual override, takes priority over auto-detection",
    "api.context_window_invalid": "Context window must be empty or a number ≥ 4096",
    "api.save": "Save",
    ...
    "skills.import_btn_title": "Import to chat input",
    "skills.import_btn_loading": "Importing...",
    "skills.import_btn_done": "✅ Imported",
    "skills.import_failed": "Import failed: ",
    ...
    "mcp.args": "Arguments",
    "mcp.args_placeholder": "e.g. -y @modelcontextprotocol/server-filesystem C:/notes",
    ...
    "memory.stat_overflow": "⚠️",
    "memory.purge_btn_label": "Purge Project",
    "memory.purge_btn_title": "Delete all project memories (irreversible)",
    "memory.purge_confirm_title": "Confirm purge all project memories?",
    "memory.purge_confirm_body": "About to delete **{count}** project memories:\n\n{names}\n\nThis action is **irreversible**. Recommended: export a backup first.\n\nConfirm purge?",
    "memory.purge_confirm_too_many": "⚠️ Project memories have reached {count}. Recommend cleanup — they're interfering with Agent thinking.",
    "memory.purge_done": "✅ Purged {count} project memories",
    "memory.purge_fail": "❌ Purge failed: {error}",
    "memory.purge_disabled_hint": "Project memories ≤ {cap}, no cleanup needed",
    "memory.export_btn_label": "Export Backup",
    "memory.export_done": "✅ Backup saved to {path}",

    // ── Prompts (Stage 2b) ──
    "prompts.title": "Saved Prompts",
    "prompts.hint": "Click the + button on the input box → Saved Prompts, then pick one to insert",
    "prompts.search_placeholder": "Search prompts...",
    "prompts.new": "＋ New",
    "prompts.empty": "No prompts yet",
    "prompts.empty_hint": "Pick a prompt on the left<br/>or click ＋ New to create one",
    "prompts.empty_hint_panel": "Write your first one in the editor on the right",
    "prompts.title_placeholder": "Title, e.g. \"Write daily report\"",
    "prompts.body_placeholder": "Prompt content (Markdown supported)...",
    "prompts.title_required": "❌ Title cannot be empty",
    "prompts.body_required": "❌ Body cannot be empty",
    "prompts.saving": "Saving...",
    "prompts.saved": "✅ Saved",
    "prompts.save_fail": "❌ Save failed: {error}",
    "prompts.delete_confirm": "Delete prompt \"{name}\"? This cannot be undone.",
    "prompts.deleted": "✅ Deleted",
    "prompts.delete_fail": "❌ Delete failed: {error}",
    "prompts.modal_title_edit": "Edit Prompt",
    "prompts.modal_title_new": "New Prompt",
    "prompts.field_title": "Title *",
    "prompts.field_body": "Prompt Content *",
    // ── Import modal (Stage 3) ──
    "prompts.import_modal_title": "Select Prompt",
    "prompts.import_search_placeholder": "Search prompts...",
    "prompts.import_select_hint": "← Pick a prompt on the left to preview",
    "prompts.import_preview_placeholder": "(preview)",
    "prompts.import_btn": "Import to Input",
    "prompts.import_failed": "❌ Import failed: prompt input not found",
    "prompts.import_empty": "No prompts yet — create some in Settings first",
    ...
    "agent_skills.generate_all": "Auto-Distill All",
    "agent_skills.generate_all_title": "Use AI to distill all candidate patterns into skills in one shot",
    "agent_skills.generated_ok": "Generated",
    "agent_skills.already_exists": "Already Exists",
    "agent_skills.generate_all_summary": "Generated {saved} / Existing {existed} / Failed {failed}",
    ...
    "chat.plan": "Plan",
    // ── Input Menu Popover (Stage 1) ──
    "input.menu.upload": "Upload File",
    "input.menu.prompts": "Prompts",
    "input.menu.skills": "Skills",
    ...
    "speed.seconds": "s",
    "speed.chars": "chars",
    "speed.cache_hit": "cache hit",
    "speed.cache_hit_label": "Cache hit",
    "speed.cache_miss_label": "Miss",
    "speed.cache_total_label": "Total",
    "settings.custom_suffix": " (Custom)",
    "settings.custom_model_placeholder": "Enter model name manually...",
    "resume.banner": "⚠ This conversation was interrupted at turn {turn} (continuation {cont}). Send a message for the agent to continue.",
    "resume.view_summary": "View last summary",
    "common.remove": "Remove",
    "common.save_enter": "Save (Enter)",
    "common.cancel_esc": "Cancel (Esc)",
    "kb.detecting": "Detecting…",
    "kb.formats.title": "File Formats",
    "kb.formats.docx": "Word Documents (.docx)",
    "kb.formats.pptx": "PowerPoint Presentations (.pptx)",
    "kb.formats.csv": "CSV Spreadsheets (.csv)",
    "kb.formats.xlsx": "Excel Spreadsheets (.xlsx)",
    "kb.formats.pdf": "PDF Documents (.pdf)",
    "kb.formats.hint": "When enabled, rebuild will scan these formats",
    "skills.cli_general_tool": "CLI General Tools",
    "skills.cli_tool_suffix": "tools",
    "skills.auto_name_hint": "Auto-generated placeholder — click ✎ to fix",
    "skills.edit_zh_name": "Edit Chinese name",
    "skills.zh_name_placeholder": "Enter Chinese name (leave empty to clear custom)",
    "skills.pattern_one": "💡 Detected repeated pattern \"{phrase}\" (occurred {count} times), can be made into a skill",
    "skills.pattern_many": "💡 Detected {count} repeated task patterns, can be made into skills",
    "skills.open_skills_panel": "Click to open Skills panel",
