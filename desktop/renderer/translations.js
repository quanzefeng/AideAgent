...
const translations = {
  zh: {
    ...
    "about.new_version": "发现新版本 v{version}",
    "about.new_version_ready": "发现新版本 v{version}，点击下载",
    "about.downloading": "下载中...",
    "about.downloaded": "v{version} 已下载完成",
    "about.download_update": "下载更新",
    "about.install_update": "立即安装并重启",
    "about.skip_version": "跳过此版本",
    "about.skipped": "已跳过版本 v{version}",
    ...
    "kb.indexing": "索引中...",
    "kb.scanning": "正在扫描和索引...",
    "kb.index_success": "已索引 {count} 篇笔记，{embedded} 个片段已向量化",
    "kb.searching": "搜索中...",
    "kb.no_results": "无结果",
  ...
  en: {
    ...
    "about.new_version": "New version v{version} available",
    "about.new_version_ready": "New version v{version}, click to download",
    ...
    "about.skip_version": "Skip This Version",
    "about.skipped": "Skipped version v{version}",
    ...
    "kb.index_success": "Indexed {count} notes, {embedded} chunks vectorized",
